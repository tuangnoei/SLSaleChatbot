...
export const DEFAULT_REPLY_OPEN =
  "ส่วนนี้น้องNarsa ขอให้แอดมินมาช่วยตอบนะคะ รอสักครู่นะคะ 🙏";
export const DEFAULT_REPLY_CLOSED =
  "ส่วนนี้น้องNarsa ขอให้แอดมินมาช่วยตอบนะคะ ตอนนี้นอกเวลาทำการ แอดมินจะตอบให้ในเวลาทำการ (จ-อา ยกเว้นวันจันทร์ 9:00–18:00) นะคะ 🙏";
